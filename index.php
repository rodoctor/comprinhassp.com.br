...
<body class="theme-invert">
            ...
            <div class="row">
                ...
                <div class="col-sm-4 linesborder">
                    ...
                    <p class="snos">
						...
						de auxiliar outras pessoas dos mais variados cantos do Brasil.<br>
						Sabemos que muitas pessoas não tem tempo de ir as compras ou mesmo fazer uma pesquisa mais detalhada de seus produtos,
    ...
    <section class="section" id="contact">
        <div class="container">
            <h1 class="text-center title">Entre em Contato</h1>
            <div class="row">
    ...
    <section class="section" id="cadastro">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-4 col-sm-offset-2 linesborder">
                    <h5><strong>Quero me cadastrar!<br></strong></h5>
                    <p class="cadastro"><span style="text-align:justify; text-shadow: none">
                        <form id="formulario" method="post" action="#">
                            <label>Nome Completo: </label><br>
                            <input type="text" name="nome" id="nome" class="form-control" required placeholder="Digite seu Nome" autofocus><br>
                            
                            <label>Celular: </label><br>
                            <input type="tel" class="form-control" name="telefone" id="telefone" required  placeholder="Ex.: (00) 0000-0000" maxlength="14"><br>
                            
                            <label>Email: </label><br>
                            <input type="email" class="form-control" name="email" id="email" placeholder="Ex.: email@dominio.com.br" required><br>

                            <label>Senha: </label><br>
                            <input type="password" class="form-control" name="senha" id="senha" placeholder="Digite sua senha" required ><br>

                            <label>Confirme a Senha: </label><br>
                            <input type="password" class="form-control" name="mesma_senha" id="mesma_senha" placeholder="Confirme sua senha" required><br>
    ...
    <section class="section" id="cadastro_ok">
        <div class="container">
            ...
            <h2 class="text-center title">CADASTRO CONCLUÍDO</h2>
